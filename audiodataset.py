...
class AudioDataset(Dataset):
    def __init__(self, funct, input_path, filelist_path, label_path=None, same_time=True, pad_thres=2):
        self.funct = funct
        self.input_path = input_path
        self.label_path = label_path
        self.same_time = same_time
        self.pad_thres = pad_thres
        self.filelist = funct.get_filelist(self.input_path, self.pad_thres, filelist_path)
