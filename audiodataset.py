...
class AudioDataset(Dataset):
    def __init__(self, funct, input_path, filelist_path, sample_rate, label_path=None, pad_short=True, short_thres=0.5, overlap_factor=0):
        self.funct = funct
    ...
    def __getitem__(self, idx):
        if(self.label_path != None):
            return self.funct.process_wavs(self.input_path, self.label_path, self.filelist[idx], self.sample_rate, self.pad_short)
        else:
